...
```
We also did boosting on model 1 (from stepwise variable selection). But the original model performs best as for classification rate (shown in the table below). Therefore, we only keep the original model.
|*Boosting*       || ||
|:------|-------:|-----:|
|*model*|orignal|Model1|
|*time*  |10.38   |5.64|
