...
par(mfrow = c(1,4))
plot.roc(roc.Train, col = "blue", auc.polygon = TRUE, main = "Train ROC for Boosting on Original Model", xlab = "False Positive Rate", ylab = "True Positive Rate",print.auc = TRUE)
...
par(mfrow = c(1,2))
plot.roc(roc.Test, col = "blue", auc.polygon = TRUE, main = "Test ROC for Boosting on Original Model", xlab = "False Positive Rate", ylab = "True Positive Rate",print.auc = TRUE)
...
```
We also did boosting after variable selection. But the original model performs best in misclassification rate, as shown in the table below. Therefore, we only keep the original model for boosting.
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, comment=NA, cache=F}
