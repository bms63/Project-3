...
## Logistic Regression-Full Model  Logistic Regression - Step Model
...
log.reg <- matrix(c(time1,time2,time3,rate1.train,rate3.train,rate5.train,rate2.test,rate4.test,rate6.test),nrow=3,ncol=3)
...
```{r, echo = F, message = F, comment = NA, cache=T}
##--------------------------------------------
