...
library(klaR);library(gridExtra);library(ROCR);library(e1071);library(gbm)
...
# Plotting Roc Curves for Model 1
plot.roc(roc.Train, col="blue", auc.polygon=TRUE,main="Train-ROC-Post", xlab="False Positive Rate", ylab="True Positive Rate", print.auc=TRUE)
plot.roc(roc.Test, col="red", auc.polygon=TRUE,main="Test-ROC-Post", xlab="False Positive Rate", ylab="True Positive Rate", print.auc=TRUE)
...
##--------------------------------------------
## Linear Discriminant Analysis - Pre-Model Selection
##--------------------------------------------
